...
> ## Status, 2026-09-09 — EVALUATED, TECHNICALLY VIABLE, NOT CURRENTLY SELECTED
>
> Pinggy's selection of 2026-09-08 is **superseded**. It is **not** technically
> rejected: it traversed the carrier NAT, its SSE streaming passed empirically
> with a real phone on cellular, and the custom-domain architecture priced
> below was feasible. Everything in this document stands as research.
>
> It is not currently selected because the operator asked for a free or
> self-hosted path to be tried first, because the privacy and data-processing
> questions below were never resolved, and because no purchase was ever
> authorised. **Do not purchase.**
>
> The standing ingress decision lives in one place and this is not it —
> see [public-ingress-options.md](public-ingress-options.md#standing-decision-2026-09-09).
> This header used to carry a copy of that decision table, which is how the two
> fell out of step.
