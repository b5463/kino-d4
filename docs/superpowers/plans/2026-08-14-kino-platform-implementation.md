...
- [ ] **Step 1: Write the four documents** (extract from `packages/kdp` source + spec 04 — no new design decisions here; where source and spec 04 disagree, source wins and the discrepancy is listed in README under "deviations").
