...
**(The route itself was not present in `apps/api/src/routes/device-rolls.ts` at the time of writing — only the columns it writes. Read the route before implementing against the request body.)**
