...
| `SLIDE_MODE` | `GPIO_TBD` | the guest switch (ECN-0006). Active low with the internal pull-up; open reads OWNER. Route depends on the JP1 23/25 expander deferred by ECN-0003. |
